...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['file']['prefix'],CF_FILE);}};$.fbuilder['version']='1.1.85';$.fbuilder['controls']=$.fbuilder['controls']||{};$.fbuilder['forms']=$.fbuilder['forms']||{};$.fbuilder['htmlEncode']=function(value)
...
{t=(new String(v[i])).replace(/(['"])/g,"\\$1");if(0<this.max&&c+1==this.max)break;if(_default)e=$('[id*="'+n+'"][vt="'+t+'"]');if(!_default||!e.length)e=$('[id*="'+n+'"][value="'+t+'"]');if(e.length)e.prop('checked',true);}
